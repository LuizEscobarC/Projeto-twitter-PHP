<?php
    ...
    if($sql->rowCount() == 1){
        ...
        $mail = new Email('localhost','test','testando123','ReplicaTwitter');
           $mail->enviarPara($_POST['email'], $info['username']);
           $url = 'challengelikett.000webhostapp.com/users/redefinir.php';
           $corpo = 'Olá '.$info['username'].', <br>
           Foi solicitada uma redefinição da sua senha na ReplicaTwitter.com. Acesse o link abaixo para redefinir sua senha.<br>
